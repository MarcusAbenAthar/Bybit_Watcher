...
class IndicadoresTendencia(Plugin):
    """
    Plugin para calcular indicadores de tendência e gerar sinais de trading,
...
def executar(self, dados, par, timeframe):
    ...
    try:
        ...
        for candle in dados:
            ...
            macd, macd_signal, macd_hist = self.calcular_macd([candle], par, timeframe)
            ...
            cursor.execute(
                ...
                SET rsi = EXCLUDED.rsi, macd = EXCLUDED.macd, macd_signal = EXCLUDED.macd_signal, macd_hist = EXCLUDED.macd_hist,
                    adx = EXCLUDED.adx, aroon_up = EXCLUDED.aroon_up, aroon_down = EXCLUDED.aroon_down, sar = EXCLUDED.sar,
                    tema = EXCLUDED.tema, kama = EXCLUDED.kama, macd_histograma = EXCLUDED.macd_histograma,
                    ...
                    sinal_macd_cruzamento_acima = EXCLUDED.sinal_macd_cruzamento_acima, stop_loss_macd_cruzamento_acima = EXCLUDED.stop_loss_macd_cruzamento_acima, take_profit_macd_cruzamento_acima = EXCLUDED.take_profit_macd_cruzamento_acima,
                    sinal_macd_cruzamento_abaixo = EXCLUDED.sinal_macd_cruzamento_abaixo, stop_loss_macd_cruzamento_abaixo = EXCLUDED.stop_loss_macd_cruzamento_abaixo, take_profit_macd_cruzamento_abaixo = EXCLUDED.take_profit_macd_cruzamento_abaixo,
                    sinal_adx_forte_alta = EXCLUDED.sinal_adx_forte_alta, stop_loss_adx_forte_alta = EXCLUDED.stop_loss_adx_forte_alta, take_profit_adx_forte_alta = EXCLUDED.take_profit_adx_forte_alta,
                    sinal_adx_forte_baixa = EXCLUDED.sinal_adx_forte_baixa, stop_loss_adx_forte_baixa = EXCLUDED.stop_loss_adx_forte_baixa, take_profit_adx_forte_baixa = EXCLUDED.take_profit_adx_forte_baixa,
                    sinal_aroon_cruzamento_acima = EXCLUDED.sinal_aroon_cruzamento_acima, stop_loss_aroon_cruzamento_acima = EXCLUDED.stop_loss_aroon_cruzamento_acima, take_profit_aroon_cruzamento_acima = EXCLUDED.take_profit_aroon_cruzamento_acima,
                    sinal_aroon_cruzamento_abaixo = EXCLUDED.sinal_aroon_cruzamento_abaixo, stop_loss_aroon_cruzamento_abaixo = EXCLUDED.stop_loss_aroon_cruzamento_abaixo, take_profit_aroon_cruzamento_abaixo = EXCLUDED.take_profit_aroon_cruzamento_abaixo,
                    sinal_sar_reversao_alta = EXCLUDED.sinal_sar_reversao_alta, stop_loss_sar_reversao_alta = EXCLUDED.stop_loss_sar_reversao_alta, take_profit_sar_reversao_alta = EXCLUDED.take_profit_sar_reversao_alta,
                    sinal_sar_reversao_baixa = EXCLUDED.sinal_sar_reversao_baixa, stop_loss_sar_reversao_baixa = EXCLUDED.stop_loss_sar_reversao_baixa, take_profit_sar_reversao_baixa = EXCLUDED.take_profit_sar_reversao_baixa,
                    sinal_tema_cruzamento_acima = EXCLUDED.sinal_tema_cruzamento_acima, stop_loss_tema_cruzamento_acima = EXCLUDED.stop_loss_tema_cruzamento_acima, take_profit_tema_cruzamento_acima = EXCLUDED.take_profit_tema_cruzamento_acima,
                    sinal_tema_cruzamento_abaixo = EXCLUDED.sinal_tema_cruzamento_abaixo, stop_loss_tema_cruzamento_abaixo = EXCLUDED.stop_loss_tema_cruzamento_abaixo, take_profit_tema_cruzamento_abaixo = EXCLUDED.take_profit_tema_cruzamento_abaixo,
                    sinal_kama_cruzamento_acima = EXCLUDED.sinal_kama_cruzamento_acima, stop_loss_kama_cruzamento_acima = EXCLUDED.stop_loss_kama_cruzamento_acima, take_profit_kama_cruzamento_acima = EXCLUDED.take_profit_kama_cruzamento_acima,
                    sinal_kama_cruzamento_abaixo = EXCLUDED.sinal_kama_cruzamento_abaixo, stop_loss_kama_cruzamento_abaixo = EXCLUDED.stop_loss_kama_cruzamento_abaixo, take_profit_kama_cruzamento_abaixo = EXCLUDED.take_profit_kama_cruzamento_abaixo,
                    sinal_macd_histograma_cruzamento_acima = EXCLUDED.sinal_macd_histograma_cruzamento_acima, stop_loss_macd_histograma_cruzamento_acima = EXCLUDED.stop_loss_macd_histograma_cruzamento_acima, take_profit_macd_histograma_cruzamento_acima = EXCLUDED.take_profit_macd_histograma_cruzamento_acima,
                    sinal_macd_histograma_cruzamento_abaixo = EXCLUDED.sinal_macd_histograma_cruzamento_abaixo, stop_loss_macd_histograma_cruzamento_abaixo = EXCLUDED.stop_loss_macd_histograma_cruzamento_abaixo, take_profit_macd_histograma_cruzamento_abaixo = EXCLUDED.take_profit_macd_histograma_cruzamento_abaixo
                )""",
            )
            (
                par,
